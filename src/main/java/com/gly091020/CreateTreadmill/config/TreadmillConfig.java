...
public class TreadmillConfig extends ConfigBase {
    ...
    public final ConfigInt TREADMILL_TEST_RADIUS = i(10, 0, "Treadmill Detection Range", "Detection range for treadmill-related logic");
    public final ConfigInt TREADMILL_BASE_SPEED = i(32, 0, "Treadmill Base Speed", "Set the base speed of the treadmill");
    public final ConfigFloat TREADMILL_FOOD_MAGNIFICATION = f(0.01f, 0, "Food Exhaustion Multiplier", "Controls the rate at which the player's food exhaustion decreases while on the treadmill");
